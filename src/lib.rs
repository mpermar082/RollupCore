...
#[derive(Debug)]
pub struct RollupCoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RollupCoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RollupCore processing");
    
    let mut processor = RollupCoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RollupCoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RollupCoreProcessor::new(false);
